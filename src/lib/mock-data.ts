...
export const notifications: Notification[] = [
  // Today — critical / unread
  {
    id: "ntf-1",
    category: "financial",
    severity: "warning",
    status: "unread",
    title: "Cotisation à régler · Commerçants Madina",
    description:
      "Échéance dans 2 jours · 1 000 000 GNF. Le débit automatique tentera Orange Money à 09h00.",
    source: "Commerçants Madina",
    groupId: "g-madina",
    timestamp: "Aujourd'hui · 08:42",
    daysFromToday: 0,
    signature: "0x9c12…44ab",
    actionLabel: "Payer maintenant",
    actionUrl: "/cotisations",
    secondaryActionLabel: "Voir le groupe",
    secondaryActionUrl: "/groupes/g-madina",
    requiresAction: true,
  },
  {
    id: "ntf-2",
    ...
    title: "Proposition d'échange reçue",
    description:
      "Aissatou Camara propose d'échanger son tour #14 contre votre tour #8 dans Commerçants Madina.",
    source: "Commerçants Madina",
    groupId: "g-madina",
    timestamp: "Aujourd'hui · 07:15",
    daysFromToday: 0,
    signature: "0x4f9b…a128",
  ...
  },
  {
    ...
    severity: "warning",
    status: "unread",
    title: "Reconnexion MTN Mobile Money requise",
    description:
      "Le jeton OAuth de votre compte MTN +224 661 00 00 00 expire dans 3 jours. Renouvelez-le pour éviter l'interruption des prélèvements automatiques.",
    source: "Service Conformité",
    timestamp: "Aujourd'hui · 06:30",
    daysFromToday: 0,
    signature: "0x7140…d1cc",
  ...
  // Yesterday — info / mixed
  {
    id: "ntf-4",
    category: "social",
    severity: "success",
    status: "unread",
    title: "Nouveau membre admis · Entrepreneurs Conakry",
    description: "Aïssatou Diallo a accepté votre invitation. Capacité : 8/10 confirmés.",
    source: "Entrepreneurs Conakry",
    groupId: "g-conakry",
    timestamp: "Hier · 18:04",
    daysFromToday: -1,
    signature: "0xa044…9b71",
    actionLabel: "Voir le groupe",
    actionUrl: "/groupes/g-conakry",
  },
  {
    id: "ntf-5",
    category: "financial",
    severity: "success",
    status: "read",
    title: "Cagnotte créditée · Tontine Famille Diallo",
    description:
      "Vous avez reçu 6 000 000 GNF sur MTN Mobile Money. Reçu numérique généré et archivé.",
    source: "Tontine Famille Diallo",
    groupId: "g-diallo",
    timestamp: "Hier · 10:38",
    daysFromToday: -1,
    signature: "0xa12c…04dd",
  ...
  },
  {
    ...
    severity: "warning",
    status: "unread",
    title: "Vote ouvert · Pénalité de retard Pilotes Donka",
    description:
      "L'organisateur propose de ramener la pénalité de 8% à 5% à partir du tour #11. Vote requis sous 4 jours.",
    source: "Pilotes Donka",
    groupId: "g-donka",
    timestamp: "Hier · 09:05",
    daysFromToday: -1,
    signature: "0xbb02…117f",
    actionLabel: "Voter",
    actionUrl: "/groupes/g-donka",
    requiresAction: true,
  },
  // This week
  {
    ...
    description:
      "La version v3.2 des CGU intègre les évolutions de l'agrément BCG-2024-018. Lecture conseillée.",
    source: "Tontine Digital",
    timestamp: "02 Jan · 14:22",
    daysFromToday: -2,
    signature: "0xc811…9203",
    actionLabel: "Lire les CGU",
    actionUrl: "/parametres",
  },
  {
    id: "ntf-8",
    ...
    description:
      "Pixel 8 · Labé · 41.220.114.78. Si ce n'est pas vous, déconnectez immédiatement cet appareil.",
    source: "Service Conformité",
    timestamp: "01 Jan · 23:48",
    daysFromToday: -3,
    signature: "0xd203…ee14",
    actionLabel: "Vérifier",
    actionUrl: "/profil",
    secondaryActionLabel: "Déconnecter",
    secondaryActionUrl: "/profil",
    requiresAction: true,
  },
  {
    id: "ntf-9",
    ...
    severity: "info",
    status: "read",
    title: "Cotisation enregistrée · Pilotes Donka",
    description: "750 000 GNF débités sur Orange Money. Référence opérateur OM-892412.",
    source: "Pilotes Donka",
    groupId: "g-donka",
    timestamp: "01 Jan · 11:02",
    daysFromToday: -3,
    signature: "0xe9f1…b202",
    actionLabel: "Voir le reçu",
    actionUrl: "/historique",
  },
  {
    ...
    severity: "info",
    status: "read",
    title: "Demande d'adhésion · Entrepreneurs Conakry",
    description:
      "Kankou Bah (score 96%) souhaite rejoindre votre groupe via l'annuaire public.",
    source: "Entrepreneurs Conakry",
    groupId: "g-conakry",
    timestamp: "31 Déc · 17:33",
    daysFromToday: -4,
    signature: "0x0021…1f88",
  ...
  // Earlier
  {
    ...
    severity: "info",
    status: "archived",
    title: "Nouveau plan disponible · Tontine Digital Enterprise",
    description:
      "Accès aux émissions premium, plafonds illimités et SLA dédié. Mise à niveau possible sans frais d'activation jusqu'au 31 janvier.",
    source: "Tontine Digital",
    timestamp: "28 Déc · 09:00",
    daysFromToday: -7,
    signature: "0x1145…6710",
  ...
  },
  {
    ...
    severity: "critical",
    status: "read",
    title: "Tentative de débit échouée · Investisseurs Kaloum",
    description:
      "Le débit de 2 000 000 GNF du 20 Nov a été rejeté par MTN (solde insuffisant). Une nouvelle tentative aura lieu sous 48h.",
    source: "Investisseurs Kaloum",
    groupId: "g-kaloum",
    timestamp: "20 Nov · 23:01",
    daysFromToday: -45,
    signature: "0x2f0a…b441",
  ...
  },
  {
    ...
    severity: "success",
    status: "archived",
    title: "Échange accepté · Tontine Famille Diallo",
    description:
      "Mariama Touré a accepté de prendre votre tour #11 contre son tour #6. Mise à jour appliquée.",
    source: "Tontine Famille Diallo",
    groupId: "g-diallo",
    timestamp: "15 Déc · 09:12",
    daysFromToday: -20,
    signature: "0x4203…8a14",
  },
  {
    id: "ntf-14",
    category: "security",
    severity: "success",
    status: "read",
    title: "Vérification biométrique activée",
    description: "Face ID enregistré sur iPhone 15 Pro · sécurité renforcée pour les paiements.",
    source: "Service Conformité",
    timestamp: "Hier · 21:08",
    daysFromToday: -1,
    signature: "0x5611…cf77",
  },
];

export function getNotificationsStats(items: Notification[]) {
  const unread = items.filter((n) => n.status === "unread").length;
  const requiresAction = items.filter((n) => n.requiresAction && n.status !== "archived").length;
  const critical = items.filter((n) => n.severity === "critical" && n.status !== "archived").length;
  const sources = new Set(items.filter((n) => n.status !== "archived").map((n) => n.source));
  return {
    unread,
    requiresAction,
    critical,
