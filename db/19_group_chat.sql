-- P1.1 — Chat de groupe (Tontine Digital)
...
-- Lecture : tout membre approuvé du groupe
...
-- Insertion : membre actif uniquement, auteur = soi
...
-- Edition / soft-delete : auteur uniquement
